...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_dates
	python -m ruff format --check finance_dates
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_dates
	python -m ruff format finance_dates
...
test-py:  ## run python tests
	python -m pytest -v finance_dates/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_dates/tests --cov=finance_dates --cov-report term-missing --cov-report xml
